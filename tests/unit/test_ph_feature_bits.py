...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("PRESSBOUND", "PRESSBOUND", 0o4000000),
        ("F_NOUN", "F_NOUN", 0o2000000),
        ("F_ADJ", "F_ADJ", 0o4000000),
        ("F_VERB", "F_VERB", 0o10000000),
        ("F_FUNC", "F_FUNC", 0o20000000),
        ("F_IRESET", "F_IRESET", 0o4000000000),
        ("FMAXIMUM", "FMAXIMUM", 0o10000000000),
        ("FWBEND", "FWBEND", 0o10000),
        ("FHAT_ROOF", "FHAT_ROOF", 0o100000),
